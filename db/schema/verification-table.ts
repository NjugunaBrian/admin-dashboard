...
export const DownloadVerificationTableRelations = relations(DownloadVerificationTable, ({ one }) => {
    return {
...
export const DownloadVerification = typeof DownloadVerificationTable.$inferSelect;